...
/**
 * This file contains the backup code for the surveyprofield_datetime plugin.
 *
...
class backup_surveyprofield_datetime_subplugin extends backup_subplugin {
    ...
    protected function define_item_subplugin_structure() {
        ...
        $subplugindatetime = new backup_nested_element('surveyprofield_datetime', ['id'], [
        ...
        // Define sources.
        $subplugindatetime->set_source_table('surveyprofield_datetime', ['itemid' => backup::VAR_PARENTID]);
