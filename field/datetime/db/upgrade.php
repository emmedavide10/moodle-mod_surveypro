...
/**
 * Keeps track of upgrades to the surveyproitem datetime
 *
 ...
 * @return bool true
 */
function xmldb_surveyprofield_datetime_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2014051701) {
        ...
        // Define field surveyproid to be dropped from surveyprofield_datetime.
        $table = new xmldb_table('surveyprofield_datetime');
        ...
        upgrade_plugin_savepoint(true, 2014051701, 'surveyprofield', 'datetime');
    }
