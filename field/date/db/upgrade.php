...
/**
 * Keeps track of upgrades to the surveyproitem date
 *
 ...
 * @return bool true
 */
function xmldb_surveyprofield_date_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2014051701) {
        ...
        // Define field surveyproid to be dropped from surveyprofield_date.
        $table = new xmldb_table('surveyprofield_date');
        ...
        upgrade_plugin_savepoint(true, 2014051701, 'surveyprofield', 'date');
    }
