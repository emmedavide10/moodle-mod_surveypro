...
/**
 * Keeps track of upgrades to the surveyproitem time
 *
 ...
 * @return bool true
 */
function xmldb_surveyprofield_time_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2014051701) {
        ...
        // Define field surveyproid to be dropped from surveyprofield_time.
        $table = new xmldb_table('surveyprofield_time');
        ...
        upgrade_plugin_savepoint(true, 2014051701, 'surveyprofield', 'time');
    }
