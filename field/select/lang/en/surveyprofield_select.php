...
$string['options_help'] = 'The list of the options for this item. You are allowed to write them as: value'.SURVEYPRO_VALUELABELSEPARATOR.'label in order to define value and label both. The label will be displayed in the drop down menu, the value will be stored in the db. If you only specify one word per line (without separator), value and label will both be set to that word.';
