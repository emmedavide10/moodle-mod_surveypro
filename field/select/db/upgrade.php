...
/**
 * Keeps track of upgrades to the surveyproitem select
 *
 ...
 * @return bool true
 */
function xmldb_surveyprofield_select_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2014051701) {
        ...
        // Define field surveyproid to be dropped from surveyprofield_select.
        $table = new xmldb_table('surveyprofield_select');
        ...
        upgrade_plugin_savepoint(true, 2014051701, 'surveyprofield', 'select');
    }
