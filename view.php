...
// Take a moment to understand where it is better to land.
$utilitylayoutman = new utility_layout($cm, $surveypro);
$itemcount = $utilitylayoutman->has_items(0, 'field', false, false, true);
...
$tab->draw_pages_bar(SURVEYPRO_TABDATAENTRY, 'cover_page');
