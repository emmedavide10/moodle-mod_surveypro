...
Feature: apply a COLLES (actual and preferred) mastertemplate to test graphs
  ...
  @javascript
  Scenario: apply COLLES (Preferred and Actual) mastertemplate, add a record and call reports
    ...
    And I set the following fields to these values:
      ...
      | Do you have any other comments?                | Hugs    |
    And I press "Submit"

    # And I select "Report" from secondary navigation
