...
$string['radiobutton_content_05'] = '<p>La parte più importante della mia formazione sta nell\'aver imparato a capire le persone molto diverse da me.</p>';
$string['radiobutton_content_06'] = '<p>Ritengo che il modo per concretizzare la mia identità sia di interagire con il maggior numero di persone.</p>';
$string['radiobutton_content_07'] = '<p>Mi piace ascoltare le opinioni delle persone che provengono da situazioni diverse dalle mie - questo mi aiuta a capire come le stesse cose possano essere viste in diversi modi.</p>';
$string['radiobutton_content_08'] = '<p>Trovo che posso rafforzare la mia posizione discutendo con qualcuno che non è d\'accordo con me.</p>';
$string['radiobutton_content_09'] = '<p>Sono sempre interessato a sapere perché le persone dicono e credono nelle cose che fanno.</p>';
$string['radiobutton_content_10'] = '<p>Spesso mi ritrovo a discutere con gli autori dei libri che leggo, cercando di dimostrare logicamente perché hanno torto.</p>';
$string['radiobutton_content_11'] = '<p>È importante per me rimanere il più possibile obiettivo quando analizzo qualcosa.</p>';
$string['radiobutton_content_12'] = '<p>Provo a pensare con le persone anziché contro di loro.</p>';
$string['radiobutton_content_13'] = '<p>Ho determinati criteri che uso per valutare gli argomenti di discussione.</p>';
$string['radiobutton_content_14'] = '<p>Mi è più facile provare a capire l\'opinione di qualcun altro che provare a valutarla.</p>';
$string['radiobutton_content_15'] = '<p>Cerco di evidenziare le debolezze degli altri pensando di aiutarli a chiarire le loro argomentazioni.</p>';
$string['radiobutton_content_16'] = '<p>Tendo a mettermi nei panni degli altri quando discutiamo, per capire perché la pensano in quel modo.</p>';
$string['radiobutton_content_17'] = '<p>Il mio modo di analizzare le cose si potrebbe chiamare \'mettere alla prova\' perché sono attento a prendere in considerazione tutti i casi.</p>';
$string['radiobutton_content_18'] = '<p>Uso la logica e la ragione al di là di ogni mia preoccupazione quando risolvo dei problemi.</p>';
