...
/**
 * mod_surveypro submission viewed event.
 *
...
/**
 * The mod_surveypro submission viewed event class.
 *
 * @package   mod_surveypro
 * @copyright 2022 onwards kordan <kordan@mclink.it>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class submission_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_submission_viewed', 'mod_surveypro');
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'surveypro', 'submission viewed',
