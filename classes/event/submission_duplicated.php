...
/**
 * mod_surveypro submission duplicated event.
 *
...
/**
 * The mod_surveypro submission duplicated event class.
 *
 * @package   mod_surveypro
 * @copyright 2022 onwards kordan <kordan@mclink.it>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class submission_duplicated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_submission_duplicated', 'mod_surveypro');
    }
