...
/**
 * The mod_surveypro usertemplate saved event class.
 *
 * @package   mod_surveypro
 * @copyright 2022 onwards kordan <kordan@mclink.it>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class usertemplate_saved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_usertemplate_saved', 'mod_surveypro');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/surveypro/utemplate_save.php', ['id' => $this->contextinstanceid]);
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'surveypro', 'usertemplate saved',
