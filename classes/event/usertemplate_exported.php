...
/**
 * mod_surveypro usertemplate exported event.
 *
...
/**
 * The mod_surveypro usertemplate exported event class.
 *
 * @package   mod_surveypro
 * @copyright 2022 onwards kordan <kordan@mclink.it>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class usertemplate_exported extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_usertemplate_exported', 'mod_surveypro');
    }
    ...
    public function get_description() {
        return "User with id '{$this->userid}' has exported the user template '{$this->other['templatename']}'.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'surveypro', 'usertemplate exported',
