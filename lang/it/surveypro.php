...
$string['cssstylefilearea'] = 'Fogli di stile';
...
$string['deletehiddenitems'] = 'Elimina gli elementi nascosti';
$string['deletevisibleitems'] = 'Elimina gli elementi visibili';
...
$string['event_submissiontopdf_downloaded'] = 'Scaricata risposta in pdf';
...
$string['feedback_deleteallresponses'] = 'Tutte le risposte sono state cancellate con successo';
...
$string['itemcontentfilearea'] = 'Contentenuto degli elementi';
$string['layout_branchingvalidation'] = 'Relazioni';
$string['layout_edititem'] = 'Modifica elemento';
$string['layout_items'] = 'Elementi';
$string['layout_itemsetup'] = 'Nuovo elemento';
$string['layout_preview'] = 'Anteprima';
$string['layout'] = 'Scheda';
$string['manageusertemplates'] = '<a href="{$a}">Gestisci i template utente</a>';
$string['maxentries'] = 'Numero massimo di risposte consentite';
$string['messageaftersubmission'] = 'Vuoi la visualizzazione dei grafici o la lista delle risposte?';
...
$string['redirectmonitor'] = 'Grafico';
$string['redirectsublist'] = 'Risposte';
...
// Maybe: $string['surveypro_view'] = 'Usa';
$string['surveypro_view_search'] = 'Ricerca';
$string['surveypro'] = 'surveypro';
$string['surveyproname_help'] = 'Choose the name of this surveypro.';
$string['surveyproname'] = 'Surveypro name';
$string['templatesfilearea'] = 'Template';
$string['thankspagefilearea'] = 'Pagina di ringraziamento';
$string['timecreated'] = 'Creato';
$string['timemodified'] = 'Modificato';
$string['tools_export'] = 'Esporta';
$string['tools_import'] = 'Importa';
$string['tools'] = 'Strumenti';
...
$string['utemplate_apply'] = 'Applica';
$string['utemplate_import'] = 'Importa';
$string['utemplate_manage'] = 'Gestione';
$string['utemplate_save'] = 'Salva';
$string['utemplate'] = 'Template utente';
...
$string['welcome_dataexport'] = 'Usa questa pagina per esportare le risposte acquisite.<br>E\' consentita l\'esportazione sia in un formato adatto ai software statistici che in un formato facilmente leggibile. Il contenuto esportato dipende dal "{$a}" scelto per ogni elemento (se disponibile).';
$string['welcome_emptysurvey'] = 'Questa indagine non contiene domande. Per costruire una nuova scheda è possibile aggiungere domande una ad una fino a realizzare uno strumento che aderisca al meglio alle proprie necessità<br>oppure importare un master template o un template utente per ottenere un scheda predefinita.';
...
$string['yes_deleteallitems'] = 'Elimina tutti gli elementi';
$string['yes_deletehiddenitems'] = 'Elimina tutti gli elementi nascosti';
$string['yes_deletevisibleitems'] = 'Elimina tutti gli elementi visibili';
$string['yes_hideallitems'] = 'Nascondi tutti gli elementi';
$string['yes_showallitems'] = 'Mostra tutti gli elementi';
