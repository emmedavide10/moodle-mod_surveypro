...
$string['event_submissiontopdf_downloaded'] = 'Una respuesta ha sido descargada a PDF';
...
$string['messageaftersubmission'] = '¿Quieres la vista gráfica o la lista de respuestas?';
...
$string['position_help'] = 'Use esta opción para elegir la posición del contenido del elemento. Puede ser hacia la izquierda de la interfaz del usuario, en una fila dedicada justo arriba de la interfaz para ingresar la contestación, o en una fila dedicada justo arriba de la interfaz que abarca a toda la fila.<br>Tome nota de que la posición izquierda fuerza  a los contenidos del elemento a texto plano sin imágenes.<br>¡Las dos posiciones \'superiores\' usualmente son necesitadas para contenidos que sean más largos de unas cuantas palabras y son necesarias para preguntas que que contienen imágenes!';
...
$string['redirectmonitor'] = 'Gráfico';
$string['redirectsublist'] = 'Respuestas';
...
// Maybe: $string['surveypro_view'] = 'Use';
...
$string['utemplates'] = 'User plantillas';
...
$string['welcome_mtemplateapply'] = 'Usted puede construir su encuesta aplicando un conjunto de elementos tomados de una plantilla maestra.<br>Tenga cuidado: todoslos demás elementos pre-existentes (si hubiera) serán eliminados definitivamente JUNTO CON TODOS LOS DATOS QUE YA HABÍAN COLECTADO.';
